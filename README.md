...
```
cd existing_repo
git remote add origin https://gccode.ssc-spc.gc.ca/abcc_rcba/documentation-guide.git
git branch -M main
...
- [ ] [Set up project integrations](https://gccode.ssc-spc.gc.ca/abcc_rcba/documentation-guide/-/settings/integrations)
